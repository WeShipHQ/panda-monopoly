...
//       type: "move",
//       playerId: currentPlayerSigner.address,
//       message: `${getPlayerName(currentPlayerSigner.address)} paid MEV tax of $${MEV_TAX_AMOUNT}`,
//       details: { taxType: "mev", amount: MEV_TAX_AMOUNT, signature },
//     });
//   } catch (error) {
//     console.error("Error paying MEV tax:", error);
...
//       type: "move",
//       playerId: currentPlayerSigner.address,
//       message: `${getPlayerName(currentPlayerSigner.address)} paid Priority Fee tax of $${PRIORITY_FEE_TAX_AMOUNT}`,
//       details: { taxType: "priority_fee", amount: PRIORITY_FEE_TAX_AMOUNT, signature },
//     });
//   } catch (error) {
//     console.error("Error paying Priority Fee tax:", error);
//     throw error;
