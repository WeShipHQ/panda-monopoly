...
export default function HeroSection() {
    ...
    const blocks = useMemo(() => {
        ...
        const rotations = [-8, -5, -3, 0, 3, 5, 8, 12]
    ...
    return (
        <div className="relative min-h-screen flex flex-col bg-white/90 border-b-8 border-black">
            ...
            <button
                ...
                className="fixed bottom-8 right-8 z-50 bg-[#ff0080] border-4 border-black shadow-[8px_8px_0_#000] px-6 py-3 font-black text-white uppercase tracking-wider hover:shadow-[12px_12px_0_#000] hover:-translate-y-1 hover:rotate-2 transition-all duration-300 active:shadow-[4px_4px_0_#000] active:translate-y-1"
            >
                🎲 Random Layout
            </button>
                        ...
                        <div key={i} className="flex items-center shrink-0">
                            ...
                            <Avatar className="w-12 h-12 md:w-16 md:h-16 border-4 border-black shadow-[4px_4px_0_#000] mx-8 shrink-0">
                                ...
                                <AvatarFallback
                                    ...
                                    className="bg-[#ff0080] text-white text-xl font-black"
                                >
                                    RD
                                </AvatarFallback>
                            </Avatar>
                            ...
                            <Avatar className="w-12 h-12 md:w-16 md:h-16 border-4 border-black shadow-[4px_4px_0_#000] mx-8 shrink-0">
                                ...
                                <AvatarFallback
                                    ...
                                    className="bg-[#9945ff] text-white text-xl font-black"
                                >
                                    BP
                                </AvatarFallback>
                            </Avatar>
