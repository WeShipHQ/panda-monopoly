...
const badgeVariants = cva(
  cn(
    'group shrink-0 flex-row items-center justify-center gap-1 overflow-hidden rounded-md border border-2 border-black px-2 py-0.5',
    Platform.select({
  ...
  ),
  {
    variants: {
      variant: {
        default: cn('bg-primary', Platform.select({ web: '[a&]:hover:bg-primary/90' })),
        secondary: cn(
